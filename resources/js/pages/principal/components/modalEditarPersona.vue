  ...
  <section>
    <modal-b ref="modalPersona">
      ...
      <div slot="footer" class="">
        <b-button variant="primary" @click="actualizar_persona">Actualizar</b-button>
...
export default {
  ...
  methods: {
    async actualizar_persona(){
      try {
        const {data} = await axios.post(`${this.ruta}/editar-persona`,this.form)
        this.$emit('persona:actualizar')
        this.form = ''
